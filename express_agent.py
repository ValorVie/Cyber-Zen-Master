...
class ExpressAgent:
    ...
    def load_self_expression_prompt(
        self, full_topic, opposite_opinion, argument, golden_sentence
    ):
        """加載自我表達prompt模板"""
    ...
    def load_golden_sentence_prompt(
        self, full_topic, opposite_opinion, critique, significance
    ):
        """加載金句prompt模板"""
    ...
    def build_self_expression(self, full_topic):
        ...
        self_expression_prompt = self.load_self_expression_prompt(
            full_topic, opposite_opinion, argument, golden_sentence
        )
        messages = [{"role": "user", "content": self_expression_prompt}]
    ...
    def build_golden_sentence(self, full_topic):
        ...
        golden_sentence_prompt = self.load_golden_sentence_prompt(
            full_topic, opposite_opinion, critique, significance
        )
        messages = [{"role": "user", "content": golden_sentence_prompt}]
